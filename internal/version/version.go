...
//
//	-ldflags "-X github.com/Einlanzerous/purser/internal/version.Version=0.14.0 \
//	          -X github.com/Einlanzerous/purser/internal/version.Commit=<40-char sha>"
//
...
// docker/metadata-action stamps WITHOUT the prefix. Report "v0.14.0" against a
// label of "0.14.0" and every deploy report is filed `claimed_not_confirmed`
